...
public class EventsFragment extends ListFragment {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        String[] eventNames = getResources().getStringArray(R.array.nombre_eventos);

        //simple_list_item_activated_1 allows the change of color in the background.
        // when the item from the lsit is selected(clicked).
        setListAdapter(new ArrayAdapter<String>(getActivity(), android.R.layout.simple_list_item_activated_1, eventNames));
    ...
    public void onListItemClick(ListView listView, View view, int position, long id) {
        OnEventSelectedListener listener = (OnEventSelectedListener) getActivity();
